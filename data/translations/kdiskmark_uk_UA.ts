...
<context>
    ...
    <message>
        ...
        <translation>Безперервна генерація</translation>
    </message>
    <message>
...
For full functionality, use the native package for your distribution or AppImage.</source>
        <translation>Ця версія KDiskMark у пісочниці має обмежений доступ до системних ресурсів.
Очищення кешу та доступ до захищених тек недоступні.
Через вимкнене очищення кешу швидкість читання може перевищувати реальні характеристики диска.
Для повної функціональності використовуйте нативний пакет для вашого дистрибутиву або AppImage.</translation>
    </message>
    <message>
